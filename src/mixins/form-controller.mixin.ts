...
export interface ConstraintsValidationMixinInterface extends FormAssociatedMixinInterface {
...
export const ConstraintsValidationMixin = <TBase extends Constructor<LitElement>>(Base: TBase): TBase & Constructor<ConstraintsValidationMixinInterface> => {
  class ConstraintsValidation extends FormControllerMixin(Base) implements ConstraintsValidationMixinInterface {
    validity: ValidityState;
    validationMessage: string | undefined;
  ...
  return ConstraintsValidation as TBase & Constructor<ConstraintsValidationMixinInterface>;
};
